...
import { Heart, Code, Sparkles, ExternalLink, Book, Shield, Lock, Calendar, ChevronDown, Flower2 } from 'lucide-react';

// @ts-ignore
import versionData from '../version.json';
// @ts-ignore
import guruMaharajImage from '../utils/Radhanath-Swami-Bhakti-Yoga.jpg';
// @ts-ignore
import guruImage from '../utils/Images/HGPranavanandaDas Prabhuji.jpg';
// @ts-ignore
import iskconLogo from '../utils/Images/Iscon_LOgo-removebg-preview.png';

const About: React.FC = () => {
  const [showFlowersParamGuru, setShowFlowersParamGuru] = useState(false);
  const [showFlowersGuru, setShowFlowersGuru] = useState(false);

  const offerFlowers = (type: 'param' | 'guru') => {
    if (type === 'param') {
      setShowFlowersParamGuru(true);
      setTimeout(() => setShowFlowersParamGuru(false), 10000);
    } else {
      setShowFlowersGuru(true);
      setTimeout(() => setShowFlowersGuru(false), 10000);
    }
  };
  ...
  return (
    <>
      ...
      `}</style>
      <div className="min-h-full w-full mx-auto space-y-6 animate-fadeIn pb-12 px-2 sm:px-4">
      {/* Header */}
      <div className="bg-gradient-to-r from-orange-600 to-amber-600 rounded-2xl p-6 sm:p-8 text-white shadow-xl">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className="bg-white/20 p-2.5 rounded-xl">
              <Sparkles size={24} className="text-yellow-200" />
            </div>
            <h1 className="text-2xl sm:text-3xl font-bold">About Sadhana Sang</h1>
          </div>
      ...
      {/* Humble Offering */}
      <section className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl shadow-xl border-2 border-orange-300 p-6 sm:p-8">
        <div className="text-center mb-6">
          <p className="text-2xl sm:text-3xl font-bold text-orange-800 mb-3">
            Om Sri Gurave Namah
          </p>
          <div className="h-0.5 w-24 bg-gradient-to-r from-transparent via-orange-500 to-transparent mx-auto mb-4"></div>
        </div>

        <div className="space-y-4 text-stone-800">
          <div className="bg-white/70 p-5 rounded-xl border border-orange-200 shadow-sm">
            <p className="italic text-base sm:text-lg text-center leading-relaxed text-orange-900">
              This entire website, in whatever small form it exists, is placed with trembling heart at the divine lotus feet of my most worshipable spiritual masters.
            </p>
          </div>

          <div className="bg-white/50 p-5 rounded-xl space-y-3">
            <p className="text-sm sm:text-base text-stone-700">
              I have no qualification, no purity, and no ability of my own. Whatever little service appears here is <strong className="text-orange-800">solely Their causeless mercy</strong> flowing through an unworthy instrument.
            </p>
            ...
            <p className="text-sm sm:text-base text-stone-700">
              ...
              And if there are countless faults and shortcomings, they belong <strong className="text-red-700">only to me</strong>.
            </p>

            <div className="bg-gradient-to-r from-orange-100 to-amber-100 p-4 rounded-xl border-l-4 border-orange-600">
            ...
            <p className="text-center text-orange-800 font-bold text-base sm:text-lg mt-4">
              Your most insignificant servant
            </p>
          </div>

          <div className="bg-gradient-to-br from-orange-100 to-amber-100 p-5 rounded-xl border-l-4 border-orange-600 shadow-sm">
            <p className="text-orange-900 italic font-semibold text-sm sm:text-base leading-relaxed">
              ...
              <span className="block mt-2 text-xs sm:text-sm text-orange-800">— Sri Caitanya Caritamrita</span>
            </p>
          </div>
        </div>
      </section>

      {/* What is Sadhana Sang */}
      <section className="bg-white rounded-2xl shadow-xl border-2 border-blue-300 overflow-hidden">
        <details className="group" open>
          <summary className="flex items-center justify-between gap-3 p-5 sm:p-6 cursor-pointer hover:bg-blue-50 transition-colors list-none">
          ...
          <div className="px-5 sm:px-6 pb-5 sm:pb-6 space-y-3">
            <p className="text-stone-700 text-sm sm:text-base leading-relaxed">
              <strong className="text-stone-900">Sadhana Sang</strong> is a comprehensive spiritual practice tracker designed to help devotees maintain consistency in their daily sadhana, set goals, and track progress.
            </p>
      ...
      {/* Features */}
      <section className="bg-white rounded-2xl shadow-xl border-2 border-green-300 overflow-hidden">
        <details className="group">
          <summary className="flex items-center justify-between gap-3 p-5 sm:p-6 cursor-pointer hover:bg-green-50 transition-colors list-none">
            <h2 className="text-lg sm:text-xl font-bold text-stone-900">Key Features</h2>
          ...
          <div className="px-5 sm:px-6 pb-5 sm:pb-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                <div key={idx} className="flex items-center gap-3 p-3 sm:p-4 bg-gradient-to-r from-white to-green-50 rounded-xl border border-green-200 hover:border-green-400 hover:shadow-md transition-all">
                  <div className="w-2 h-2 bg-gradient-to-br from-green-600 to-emerald-600 rounded-full flex-shrink-0"></div>
                  <span className="text-stone-800 text-xs sm:text-sm font-medium">{feature}</span>
                </div>
              ))}
            </div>

            <div className="mt-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-4 sm:p-5 border-2 border-purple-300 shadow-sm">
              <div className="flex flex-col sm:flex-row items-start sm:items-center sm:justify-between gap-4">
                ...
                <a
                  href="/festivals"
                  className="w-full sm:w-auto px-4 sm:px-5 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white text-sm font-bold rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all shadow-md hover:shadow-lg text-center whitespace-nowrap"
                >
                  Explore Festivals
                </a>
              </div>
      ...
      <section className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl shadow-xl border-2 border-orange-300 p-6 sm:p-8">
        <div className="text-center mb-6">
          <p className="text-2xl sm:text-3xl font-bold text-orange-800 mb-2">
            Om Sri Gurave Namah
          </p>
          <div className="h-0.5 w-32 bg-gradient-to-r from-transparent via-orange-500 to-transparent mx-auto mb-2"></div>
          <p className="text-orange-700 font-semibold text-base sm:text-lg italic">
            All glories to Sri Guru and Sri Gauranga
          </p>
        </div>
        
        {/* Param Gurumaharaj - HH Radhanath Swamy */}
        <div className="mb-8 bg-white rounded-2xl p-5 sm:p-6 shadow-lg border-2 border-orange-200 relative overflow-hidden">
          {/* Flower Animation */}
          {showFlowersParamGuru && (
            <div className="absolute inset-0 pointer-events-none z-10 overflow-hidden">
              {[...Array(25)].map((_, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="absolute animate-float-flower text-4xl"
                    style={{
          ...
          <div className="flex flex-col items-center mb-4">
            <div className="relative group w-full max-w-md">
              <div className="absolute -inset-2 bg-gradient-to-br from-orange-400 to-amber-400 rounded-2xl blur-lg opacity-50 group-hover:opacity-75 transition"></div>
              <div className="relative bg-gradient-to-br from-white to-orange-50 rounded-2xl p-3 sm:p-4 shadow-xl ring-2 ring-orange-400">
                <img 
                  src={guruMaharajImage}
                  alt="HH Radhanath Swamy Maharaj" 
          ...
          <div className="text-center mb-4">
            <h3 className="text-lg sm:text-xl font-bold bg-gradient-to-r from-orange-600 to-amber-600 text-white py-2 px-5 rounded-xl shadow-md inline-block mb-2">
              HH Radhanath Swamy Maharaj
            </h3>
            <p className="text-orange-800 font-bold text-sm sm:text-base mb-3">Param Gurumaharaj</p>
            <button
              onClick={() => offerFlowers('param')}
              className="px-6 py-3 bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-xl font-bold text-sm shadow-lg hover:shadow-xl hover:from-pink-600 hover:to-rose-600 transition-all transform hover:scale-105 active:scale-95 flex items-center gap-2 mx-auto"
            >
              <Flower2 size={20} />
              Offer Flowers
            </button>
          ...
          <div className="space-y-3 text-sm sm:text-base">
            ...
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-4 rounded-xl">
              <p className="text-stone-800 text-xs sm:text-sm italic">
                His teachings on devotion, service, and surrender to Krishna are like nectar for fallen souls. Every word from his lotus mouth is a treasure, every instruction a divine benediction.
              </p>
            </div>

            <div className="bg-yellow-50 p-4 rounded-xl border-2 border-yellow-300">
              <p className="text-yellow-900 font-bold text-center text-xs sm:text-sm">
        ...
        <div className="bg-white rounded-2xl p-5 sm:p-6 shadow-lg border-2 border-orange-200 relative overflow-hidden">
          {/* Flower Animation */}
          {showFlowersGuru && (
            <div className="absolute inset-0 pointer-events-none z-10 overflow-hidden">
              {[...Array(25)].map((_, i) => {
          ...
          <div className="text-center mb-4">
            <h3 className="text-lg sm:text-xl font-bold bg-gradient-to-r from-orange-600 to-amber-600 text-white py-2 px-3 sm:px-4 rounded-xl shadow-md inline-block mb-2">
              HG Pranavananda Das Prabhuji
            </h3>
            <p className="text-orange-800 font-bold text-sm sm:text-base">My Spiritual Master</p>
            <p className="text-stone-600 text-xs sm:text-sm mt-1">
              Appearance Day: November 21, 1995
            </p>
            <button
              onClick={() => offerFlowers('guru')}
              className="mt-3 px-6 py-3 bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-xl font-bold text-sm shadow-lg hover:shadow-xl hover:from-pink-600 hover:to-rose-600 transition-all transform hover:scale-105 active:scale-95 flex items-center gap-2 mx-auto"
            >
              <Flower2 size={20} />
              Offer Flowers
            </button>
          ...
          <div className="space-y-3 text-xs sm:text-sm">
            <div className="bg-orange-50 p-4 rounded-xl border-l-4 border-orange-500">
              <p className="font-semibold text-orange-900 mb-1 text-xs sm:text-sm">
            ...
            <div className="bg-gradient-to-r from-yellow-50 to-amber-50 p-4 rounded-xl border-2 border-yellow-300">
              <p className="text-yellow-900 font-bold mb-2 text-xs sm:text-sm">His Divine Qualities:</p>
            ...
            <div className="bg-orange-100 p-4 rounded-xl text-center border-2 border-orange-400">
              <p className="text-orange-900 font-bold text-xs sm:text-sm italic">
        ...
        <div className="mt-6 space-y-3 text-center">
          ...
          <p className="text-orange-900 italic text-sm sm:text-base leading-relaxed bg-white/70 p-4 rounded-xl">
            I am nothing but an insignificant servant, forever indebted to Their divine grace.
          </p>
          
          <div className="bg-gradient-to-r from-amber-100 to-orange-100 p-3 rounded-full inline-block shadow-md">
            <p className="text-amber-900 text-sm sm:text-base font-bold">
              All Glories to Sri Guru and Sri Gauranga
            </p>
      ...
      {/* Developer Info */}
      <section className="bg-white rounded-2xl shadow-xl border-2 border-blue-300 p-5 sm:p-6">
        ...
        <div className="space-y-4">
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-5 rounded-xl border-2 border-blue-300 shadow-sm">
            <div className="flex items-start gap-3 mb-4">
              <div className="bg-blue-100 p-2 rounded-full">
                <Code className="text-blue-600" size={18} />
              </div>
              <div className="flex-1">
                <h3 className="text-base sm:text-lg font-bold text-stone-900">Developed by</h3>
                <p className="text-blue-900 text-base font-semibold mt-1">Javili Jashwanth</p>
